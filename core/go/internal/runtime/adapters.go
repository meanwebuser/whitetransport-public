...
import (
	...
	dionadapter "github.com/meanwebuser/whitetransport/core/internal/adapters/dion"
	...
	telemostadapter "github.com/meanwebuser/whitetransport/core/internal/adapters/telemost"
	vkadapter "github.com/meanwebuser/whitetransport/core/internal/adapters/vk"
	vkcalladapter "github.com/meanwebuser/whitetransport/core/internal/adapters/vkcall"
...
func (r *ProviderRegistry) registerBuiltins() {
	...
	r.factories["telemost"] = func() provider.Provider { return &telemostadapter.Provider{} }
	r.factories["dion"] = func() provider.Provider { return &dionadapter.Provider{} }
	r.factories["vkcall"] = func() provider.Provider { return &vkcalladapter.Provider{} }
