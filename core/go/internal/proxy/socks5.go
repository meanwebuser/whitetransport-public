...
type Server struct {
	...
	// DNSOverStreamFallback converts DNS datagrams to DNS-over-TCP through
	// EgressDialer when the selected carrier has no packet-capable endpoint.
	DNSOverStreamFallback bool
