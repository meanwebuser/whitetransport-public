...
// Start starts the default engine and returns initialization failures to the
// embedding application. Partially initialized resources are closed before
...
// Stop shuts the default engine down and returns teardown failures to the
