...
Полный релиз `0.5.0` для Android 13+, macOS Apple Silicon, Ubuntu x64 и
Windows x64 находится на странице
[Releases](https://github.com/meanwebuser/whitetransport-public/releases/tag/v0.5.0).
Артефакты включают native runtime, клиентскую конфигурацию и sing-box; их SHA-256
опубликованы рядом с файлами. Все версии `0.5.x` используют одну линию
совместимости, а `0.6.x` будет отдельной линией.
